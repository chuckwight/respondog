...
public class Question implements Serializable, Cloneable {
	...
	Question(int t) {
		...
		case (5): this.type = "NUMERIC";
				  ...
				  this.requiredPrecision = 1; // percent
				  break;
	...
	public String print(String showWork,String studentAnswer,Integer attemptsRemaining) {
		...
		case 1: // Multiple Choice
			...
			buf.append("<span style='color:#990000;font-size: small;'>Select only the best answer:</span><br/>");
		...
		case 2: // True/False
			buf.append(text);
			buf.append("<br/>");
			buf.append("<span style='color:#990000;font-size: small;'>Select true or false:</span><br/>");
		...
		case 3: // Select Multiple
			buf.append(text + "<br/>");
			for (int i=0; i<nChoices; i++) choice_keys.add(Character.valueOf((char)('a'+i)));
			buf.append("<span style='color:#990000;font-size: small;'>Select all of the correct answers:</span><br/>");
			while (choice_keys.size()>0) {
				choice = choice_keys.remove(scrambleChoices?rand.nextInt(choice_keys.size()):0);
		...
		case 4: // Fill-in-the-Word
			buf.append(text);
			buf.append("<br/>");
			buf.append("<span style='color:#990000;font-size: small;'>Enter " + (correctAnswer.isEmpty()?"a":"the correct") + " word or phrase:</span><br/>");
		...
		case 5: // Numeric Answer
			...
			case 0: buf.append("<span style='color:#990000;font-size: small;'>Enter the exact value. <a href=# onclick=\"alert('Your answer must have exactly the correct value. You may use scientific E notation. Example: enter 3.56E-12 to represent the number 3.56\u00D710\u207B\u00B9\u00B2');return false;\">&#9432;</a></span><br/>"); break;
			case 1: buf.append("<span style='color:#990000;font-size: small;'>Enter the value with the appropriate number of significant figures. <a href=# onclick=\"alert('Use the information in the problem to determine the correct number of sig figs in your answer. You may use scientific E notation. Example: enter 3.56E-12 to represent the number 3.56\u00D710\u207B\u00B9\u00B2');return false;\">&#9432;</a></span><br/>"); break;
			case 2: int sf = (int)Math.ceil(-Math.log10(requiredPrecision/100.))+1;
				buf.append("<span style='color:#990000;font-size: small;'>Include at least " + sf + " significant figures in your answer. <a href=# onclick=\"alert('To be scored correct, your answer must agree with the correct answer to at least " + sf + " significant figures. You may use scientific E notation. Example: enter 3.56E-12 to represent the number 3.56\u00D710\u207B\u00B9\u00B2');return false;\">&#9432;</a></span><br/>"); break;
			case 3: buf.append("<span style='color:#990000;font-size: small;'>Enter the value with the appropriate number of significant figures. <a href=# onclick=\"alert('Use the information in the problem to determine the correct number of sig figs in your answer. You may use scientific E notation. Example: enter 3.56E-12 to represent the number 3.56\u00D710\u207B\u00B9\u00B2');return false;\">&#9432;</a></span><br/>"); break;
			default:
			}
	...
	String printAll() {
		...
		case 2: // True/False
			buf.append(text + "<br/>");
			buf.append("<span style='color:#990000;font-size: small;'>Select true or false:</span><UL>");
			buf.append("<LI>" 
		...
		case 3: // Select Multiple
			buf.append(text + "<br/>");
			buf.append("<span style='color:#990000;font-size: small;'>Select all of the correct answers:</span>");
			buf.append("<UL" + (scrambleChoices?" style=color:red":"") + ">");
			while (choice_keys.size()>0) {
				choice = choice_keys.remove(scrambleChoices?rand.nextInt(choice_keys.size()):0);
				buf.append("<LI>"
	...
	String printAllToStudents(String studentAnswer,boolean isInstructor) {
		// use this method to display an example of the question, correct answer and solution
		...
		boolean showAnswer = !isInstructor || !studentAnswer.isEmpty();
		switch (getQuestionType()) {
		case 1: // Multiple Choice
			buf.append(text + "<br/>");
			buf.append("<span style='color:#990000;font-size: small;'>Select only the best answer:</span><br/>");
		...
		case 5: // Numeric Answer
			...
			buf.append("<span style='border: 1px solid black'>"
					+ (showDetails && correctAnswer!=null && !correctAnswer.isEmpty()?"<b>" + getCorrectAnswer() + "</b>":"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;")
					+ "</span>");
	...
	public String edit() {
		...
		try {
			...
			case 1: // Multiple Choice
				...
				buf.append("<span style='color:#990000;font-size: small;'>Select only the best choice:</span><br/>");
				for (int i=0;i<5;i++) { 
					if (i < nChoices) {
			...
			case 4: // Fill-in-the-Word
				...
				buf.append("<span style='color:#990000;font-size: small;'>Enter " + (correctAnswer.isEmpty()?"a":"the correct") + " word or phrase.<br/>"
