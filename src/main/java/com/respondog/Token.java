...
public class Token extends HttpServlet {
	...
	// This servlet is the OpenID Connection starting point for platforms to reach ResponDog
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		try {
			...
			if (d==null) response.sendRedirect("/Registration.jsp?message=To+start+using+ResponDog,+please+register+your+LMS.");
